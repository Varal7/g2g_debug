...
def run_training(data_path='data/solvation_open',save_dir='checkpoints',args_file=None,
    ...
    start = time.time()
    generate_pairs(input_file, train_file, mol_file,args,save_dir,constraint_file,adjacency_file)
    end = time.time()
